...
```bash
packer.io build -var 'aws_access_key=XXXXXXXXXXXXXXXXXXXX' -var 'aws_secret_key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' -var 'aws_region=us-east-1' -var 'aws_source_ami=ami-a4dc46db' -var 'aws_instance_type=t2.micro' packer.json
...
```bash
//this command to Windows 
packer.io build -var 'aws_access_key=XXXXXXXXXXXXXXXXXXXXXXXXX' -var 'aws_secret_key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'  -var 'aws_region=us-east-1'  -var 'aws_source_ami=ami-b8f3b5c7' -var 'aws_instance_type=t2.micro' windows.json
